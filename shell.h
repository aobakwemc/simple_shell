...
/**
 * struct listOfStr - Singly linked list
...
/**
 * struct carrydata - contains pseudo-arguements to pass into a function,
 ...
 * @status: It returns status of the last exec'd command
 * @cmd_buf: Address of pointer to cmd_buf, on if chaining
 * @cmd_buf_type: CMD_type ||, &&, ;
 * @readfd: The fd from which to read line input
 * @histcount: The history line number count
 */
typedef struct carrydata
{
	char *arg;
	char **argv;
	char *path;
